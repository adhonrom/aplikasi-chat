...
class ChatRoom extends React.Component {
  constructor(props, context) {
    ...
    this.state = {
      messages: [{
        id: 1,
        sender: 'Html Hint',
        senderAvatar: 'https://i0.wp.com/www.winhelponline.com/blog/wp-content/uploads/2017/12/user.png?fit=256%2C256&quality=100&ssl=1',
        message: 'Hello 👋' },
  ...
  render() {
    ...
    users[0] = { name: 'Html Hint', avatar: 'https://i0.wp.com/www.winhelponline.com/blog/wp-content/uploads/2017/12/user.png?fit=256%2C256&quality=100&ssl=1' };
    users[1] = { name: 'Test', avatar: 'https://i0.wp.com/www.winhelponline.com/blog/wp-content/uploads/2017/12/user.png?fit=256%2C256&quality=100&ssl=1' };
    /* Html Hint with two other users :)
